...
#define  MAIN_PANEL_STOP                  19      /* control type: picture, callback function: StopCallback */
#define  MAIN_PANEL_RUNAGAIN              20      /* control type: picture, callback function: RunAgainCallback */
...
#define  MAIN_PANEL_CONFIGURE             23      /* control type: picture, callback function: ExpListCallback */
...
#define  MAIN_PANEL_SMU1                  27      /* control type: radioButton, callback function: (none) */
#define  MAIN_PANEL_SMU2                  28      /* control type: radioButton, callback function: (none) */
