...
#define  PANEL_V_I_PICTURE_6              12      /* control type: picture, callback function: (none) */
#define  PANEL_V_I_DECORATION_SMU1        13      /* control type: deco, callback function: VISMU1DecoCallback */
#define  PANEL_V_I_TEXTMSG                14      /* control type: textMsg, callback function: (none) */
#define  PANEL_V_I_PICTURE_2              15      /* control type: picture, callback function: (none) */
#define  PANEL_V_I_PICTURE_4              16      /* control type: picture, callback function: (none) */
#define  PANEL_V_I_PICTURE_7              17      /* control type: picture, callback function: (none) */
#define  PANEL_V_I_ST_TEXT_1              18      /* control type: textMsg, callback function: VISMU1DecoCallback */
...
#define  PANEL_V_I_BG_SMU2                23      /* control type: canvas, callback function: (none) */
#define  PANEL_V_I_GAP1UNIT               24      /* control type: textMsg, callback function: VISMU1DecoCallback */
#define  PANEL_V_I_STOP2UNIT              25      /* control type: textMsg, callback function: VISMU2DecoCallback */
#define  PANEL_V_I_GAP2UNIT               26      /* control type: textMsg, callback function: VISMU2DecoCallback */
#define  PANEL_V_I_START_1                27      /* control type: textMsg, callback function: VISMU1DecoCallback */
#define  PANEL_V_I_STOP_1                 28      /* control type: textMsg, callback function: VISMU1DecoCallback */
#define  PANEL_V_I_STEP_1                 29      /* control type: textMsg, callback function: VISMU1DecoCallback */
#define  PANEL_V_I_STEP_2                 30      /* control type: textMsg, callback function: VISMU2DecoCallback */
#define  PANEL_V_I_STOP_2                 31      /* control type: textMsg, callback function: VISMU2DecoCallback */
#define  PANEL_V_I_START_2                32      /* control type: textMsg, callback function: VISMU2DecoCallback */
#define  PANEL_V_I_ST_TEXT_2              33      /* control type: textMsg, callback function: VISMU2DecoCallback */
#define  PANEL_V_I_STOP1UNIT              34      /* control type: textMsg, callback function: VISMU1DecoCallback */
