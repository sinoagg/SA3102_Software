...
#define  IDVDS_CFG_PIC_IDVD_SOURCE_2      3       /* control type: picture, callback function: (none) */
...
#define  IDVDS_CFG_RING_5                 25      /* control type: ring, callback function: IdVdGATEDecoCB */
...
#define  IDVDS_CFG_TEXTMSG_27             29      /* control type: textMsg, callback function: IdVdGATEDecoCB */
#define  IDVDS_CFG_TEXTMSG_28             30      /* control type: textMsg, callback function: IdVdGATEDecoCB */
#define  IDVDS_CFG_TEXTMSG_29             31      /* control type: textMsg, callback function: IdVdGATEDecoCB */
#define  IDVDS_CFG_TEXTMSG_30             32      /* control type: textMsg, callback function: IdVdGATEDecoCB */
