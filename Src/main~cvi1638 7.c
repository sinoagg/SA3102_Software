...
void CVICALLBACK ComCallback(int portNumber, int eventMask, void * callbackData)
{
	...
	if((RxData1.rxStopSign == 0x01) || (RxData2.rxStopSign == 0x01) || (Graph.pCurveArray->numOfPlotDots == Graph.pCurveArray->numOfTotalDots) || ((Graph.pCurveArray + 1)->numOfPlotDots == (Graph.pCurveArray + 1)->numOfTotalDots))
	{
